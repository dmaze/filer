defmodule FilerWeb.ContentController do
  ...
  def create(conn, _params) do
    ...
    :ok = FilerStore.put(FilerStore, {hash, :pdf}, IO.iodata_to_binary(body))
  ...
  def show_pdf(conn, %{"content_id" => id}) do
    ...
    case FilerStore.get(FilerStore, {content.hash, :pdf}) do
      {:ok, content} ->
        conn
  ...
  def show_png(conn, %{"content_id" => id}) do
    ...
    case FilerStore.get(FilerStore, {content.hash, :png, :res72}) do
      {:ok, content} ->
        conn
